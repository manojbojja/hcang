...
myApp.controller('codeSubmissions',['$scope','$http', function($scope, $http){
    ...
    $scope.customFilter = function(submission){
        if ($scope.query.length > 0) {
            if($scope.query.toLowerCase() == 'apparel' && submission.category == 0){
                return submission;
            }
            if($scope.query.toLowerCase() == 'accessories' && submission.category == 1){
                return submission;
            }
